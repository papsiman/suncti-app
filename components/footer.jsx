          ...
          <div className="footer bg-secondary text-white px-4 md:px-32 xl:px-64 py-16 relative overflow-hidden">
            <aside>
              ...
              <p className="max-w-md">
                ...
                <br />
                We offers Consultants, Implement and Operate of the Skype for Business (On-premise & Online)/ Microsoft Teams Phone in Thailand and ASEAN country. More than sixteen years our experiences in enterprise voice area.
              </p>
            </aside>
            <nav>
              <h6 className="footer-title">Services</h6>
              <a className="link link-hover">Audiocodes</a>
              <a className="link link-hover">Paradoxes</a>
              <a className="link link-hover">Prouduct Catalog</a>
            </nav>
            <nav>
            ...
            <nav>
              ...
              <a className="link link-hover">Tel: +662-111-6066</a>
