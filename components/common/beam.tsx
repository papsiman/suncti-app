...
export function Beam() {
  ...
  return (
    <div
      className="relative flex h-[500px] w-full items-center justify-center overflow-hidden px-8"
      ref={containerRef}
    >
      <div className="flex size-full flex-col max-h-[200px] items-stretch justify-between gap-10">
