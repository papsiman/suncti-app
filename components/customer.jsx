    ...
    return (
      <div className="py-16 px-5 flex justify-center">
        <div className="max-w-5xl flex flex-col items-center">
          ...
          <div className="flex flex-wrap flex-grow-0 justify-between gap-8 py-16">
            {customers.map((customer) => (
              <div key={customer.id} className="w-52 shadow-xl rounded-xl bg-gray-50 hover:scale-105 cursor-pointer">
                <div className="flex h-32 justify-center items-center">
                  <Image src={customer.img} alt="" loading = 'lazy' width={128} height={128} style={{ width: '128px', height: 'auto'}}/>
                </div>
